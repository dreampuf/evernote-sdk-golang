...
type PublicUserInfo struct {
	...
	ServiceLevel    *types.ServiceLevel `thrift:"serviceLevel,7" json:"serviceLevel,omitempty"`
}
...
var PublicUserInfo_ServiceLevel_DEFAULT types.ServiceLevel

func (p *PublicUserInfo) GetServiceLevel() types.ServiceLevel {
...
type UserUrls struct {
	NoteStoreUrl     *string `thrift:"noteStoreUrl,1" json:"noteStoreUrl,omitempty"`
	WebApiUrlPrefix  *string `thrift:"webApiUrlPrefix,2" json:"webApiUrlPrefix,omitempty"`
	UserStoreUrl     *string `thrift:"userStoreUrl,3" json:"userStoreUrl,omitempty"`
	UtilityUrl       *string `thrift:"utilityUrl,4" json:"utilityUrl,omitempty"`
	MessageStoreUrl  *string `thrift:"messageStoreUrl,5" json:"messageStoreUrl,omitempty"`
	UserWebSocketUrl *string `thrift:"userWebSocketUrl,6" json:"userWebSocketUrl,omitempty"`
}
...
type AuthenticationResult_ struct {
	...
	Urls                     *UserUrls       `thrift:"urls,10" json:"urls,omitempty"`
}
...
type BootstrapSettings struct {
	...
	EnableGoogle *bool `thrift:"enableGoogle,16" json:"enableGoogle,omitempty"`
}
